# Mac OS X Feecoind Build Instructions
...
* See readme-qt.rst for instructions on building Feecoin QT, the
...
## Useful commands
    ...
    ./feecoind --help  # for a list of command-line options.
    ./feecoind -daemon # to start the feecoin daemon.
    ./feecoind help    # When the daemon is running, to get a list of RPC commands
