...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/hanzou-x/flappycoin>";
    const std::string URL_WEBSITE = "<https://flappycoins.wordpress.com>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Flappycoin version %s\n", FormatFullVersion());
}
