...
public:
    CMainParams() {
        ...
        vAlertPubKey = ParseHex("0684cce1bac0d543f104cbff2bd23680056a3b9ea05e1137d2ff90eeb5e08472eb500322593a2cb06fbf8297d7beb6cd30cb90f98153b5b7cce1493749e41e0284");
        nDefaultPort = 22001;
        nRPCPort = 22002;
        ...
        const char* pszTimestamp = "FEECOIN STARTER";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1524035586, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1524035586;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 2880952;
...
//        LogPrintf("hashGenesisBlock=%s\n", hashGenesisBlock.ToString());
          ...
          assert(hashGenesisBlock == uint256("0x00000d3a04b83a5fc57410facea04ed6a74d53e9c217eb3f4dbddf795228ddb3"));
          assert(genesis.hashMerkleRoot == uint256("0xf6832fdbc3fa21f07945c03ebec5f65264bb311f02a42ca2c130879ade73b269"));
...
public:
    CTestNetParams() {
        ...
        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 65); // feecoin test net start with T
