...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "LEMANUM STARTER";
        ...
        vout.resize(1);
        vout[0].SetEmpty();
        CTransaction txNew(1, 1512925232, vin, vout, 0);
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime    = 1512925232;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 1582036;
        ...
        assert(hashGenesisBlock == uint256("0x00000d1fe549376f43da642f73b0e82f9808395bd0afc353e186c52623b75460"));
        assert(genesis.hashMerkleRoot == uint256("0xf0c08183494aea7a54cc5e36edf7855ad7815cb0a605e94289d77137d592e552"));

       //MineGenesis(genesis);

       
      vSeeds.push_back(CDNSSeedData("188.226.148.47", "188.226.148.47")); 
