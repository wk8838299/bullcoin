# Mac OS X Lemanumd Build Instructions
...
* See readme-qt.rst for instructions on building Lemanum QT, the
...
## Useful commands
    ...
    ./lemanumd --help  # for a list of command-line options.
    ./lemanumd -daemon # to start the lemanum daemon.
    ./lemanumd help    # When the daemon is running, to get a list of RPC commands
