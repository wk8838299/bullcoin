...
LITECOIND=${LITECOIND:-$SRCDIR/flappycoind}
LITECOINCLI=${LITECOINCLI:-$SRCDIR/flappycoin-cli}
LITECOINTX=${LITECOINTX:-$SRCDIR/flappycoin-tx}
LITECOINQT=${LITECOINQT:-$SRCDIR/qt/flappycoin-qt}
